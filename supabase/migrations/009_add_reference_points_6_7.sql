-- Add reference points 6 and 7 to the permanent NadhafaDZ service-area geofence.
...
as $$
  with service_points(latitude, longitude) as (
    values
      ...
      (36.655100::double precision, 3.118318::double precision),
      (36.656365::double precision, 3.117925::double precision),
