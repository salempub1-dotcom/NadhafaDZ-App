...
export default function ReportScreen() {
  ...
  return <SafeAreaView style={styles.safe}>
    <View style={styles.card}>
      ...
      <Text style={styles.neighborhood}>الحي المحدد: {neighborhood}</Text>
...
const styles=StyleSheet.create({safe:{flex:1,backgroundColor:'#F5FAF7',padding:20,justifyContent:'center'},card:{backgroundColor:'#fff',borderRadius:24,padding:24,borderWidth:1,borderColor:'#DCE7E1'},emoji:{fontSize:52,textAlign:'center'},title:{fontSize:25,fontWeight:'900',color:'#17352A',textAlign:'center',marginTop:10},neighborhood:{textAlign:'center',color:'#168A55',fontWeight:'800',marginTop:8},body:{textAlign:'right',color:'#6B7A73',lineHeight:23,marginTop:12},button:{backgroundColor:'#168A55',borderRadius:16,padding:17,marginTop:24},buttonText:{color:'#fff',fontWeight:'900',fontSize:17,textAlign:'center'},note:{backgroundColor:'#EAF7F0',borderRadius:16,padding:16,marginTop:18},noteTitle:{textAlign:'right',fontWeight:'900',color:'#168A55'},noteText:{textAlign:'right',color:'#17352A',lineHeight:21,marginTop:6}});
