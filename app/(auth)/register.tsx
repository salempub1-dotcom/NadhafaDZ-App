          ...
          <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.card}>
              ...
              <View style={[styles.inputWrap, focus === 'name' && styles.inputFocus]}>
                <Ionicons name="person-outline" size={20} color={focus === 'name' ? colors.primary : '#7D8A84'} />
                <TextInput style={styles.input} placeholder="مثال: محمد بن علي" placeholderTextColor="#9AA6A0" value={name} onChangeText={setName} onFocus={() => setFocus('name')} onBlur={() => setFocus(null)} />
              </View>
              ...
              <View style={[styles.inputWrap, focus === 'email' && styles.inputFocus]}>
                ...
                <TextInput style={styles.input} placeholder="name@email.com" placeholderTextColor="#9AA6A0" autoCapitalize="none" keyboardType="email-address" value={email} onChangeText={setEmail} onFocus={() => setFocus('email')} onBlur={() => setFocus(null)} />
              </View>
              ...
              <View style={[styles.inputWrap, focus === 'password' && styles.inputFocus]}>
                ...
                <TextInput style={styles.input} placeholder="6 أحرف على الأقل" placeholderTextColor="#9AA6A0" secureTextEntry={!showPassword} value={password} onChangeText={setPassword} onFocus={() => setFocus('password')} onBlur={() => setFocus(null)} />
              </View>
