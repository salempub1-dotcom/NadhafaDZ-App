...
const styles = StyleSheet.create({
  ...
  photoTint: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(7,60,50,0.10)' },
  fadeTop: { position: 'absolute', left: 0, right: 0, bottom: 88, height: 90, backgroundColor: 'rgba(245,250,247,0.10)' },
  fadeMid: { position: 'absolute', left: 0, right: 0, bottom: 38, height: 92, backgroundColor: 'rgba(245,250,247,0.58)' },
  fadeBottom: { position: 'absolute', left: 0, right: 0, bottom: 0, height: 58, backgroundColor: colors.background },
  waveOne: { position: 'absolute', left: -70, right: -70, bottom: 16, height: 74, borderRadius: 999, backgroundColor: 'rgba(227,242,233,0.78)', transform: [{ rotate: '-4deg' }] },
  waveTwo: { position: 'absolute', left: -90, right: -90, bottom: -18, height: 80, borderRadius: 999, backgroundColor: colors.background, transform: [{ rotate: '3deg' }] },
